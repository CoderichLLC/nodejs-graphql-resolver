...
describe('QueryResolver', () => {
  ...
  test('Query syntax', () => {
    expect(factory({ model: 'Author' }).id(1).one().toObject()).toMatchObject({ model: 'Author', op: 'findOne', where: { id: 1 }, select: { _id: true, authored: true, biography: true, name: true, telephone: true } });
